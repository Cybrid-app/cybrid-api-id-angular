...
export class BankApplicationsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listBankApplications(page?: number, perPage?: number, bankGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ApplicationListIdpModel>;
    public listBankApplications(page?: number, perPage?: number, bankGuid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ApplicationListIdpModel>>;
    public listBankApplications(page?: number, perPage?: number, bankGuid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ApplicationListIdpModel>>;
    public listBankApplications(page?: number, perPage?: number, bankGuid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
