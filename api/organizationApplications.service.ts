...
export class OrganizationApplicationsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOrganizationApplication(clientId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ApplicationIdpModel>;
    public getOrganizationApplication(clientId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ApplicationIdpModel>>;
    public getOrganizationApplication(clientId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ApplicationIdpModel>>;
    public getOrganizationApplication(clientId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (clientId === null || clientId === undefined) {
            throw new Error('Required parameter clientId was null or undefined when calling getOrganizationApplication.');
        }
        ...
        return this.httpClient.get<ApplicationIdpModel>(`${this.configuration.basePath}/api/organization_applications/${encodeURIComponent(String(clientId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateOrganizationApplication(clientId: string, patchApplicationIdpModel: PatchApplicationIdpModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ApplicationIdpModel>;
    public updateOrganizationApplication(clientId: string, patchApplicationIdpModel: PatchApplicationIdpModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ApplicationIdpModel>>;
    public updateOrganizationApplication(clientId: string, patchApplicationIdpModel: PatchApplicationIdpModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ApplicationIdpModel>>;
    public updateOrganizationApplication(clientId: string, patchApplicationIdpModel: PatchApplicationIdpModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (clientId === null || clientId === undefined) {
            throw new Error('Required parameter clientId was null or undefined when calling updateOrganizationApplication.');
        }
        if (patchApplicationIdpModel === null || patchApplicationIdpModel === undefined) {
            throw new Error('Required parameter patchApplicationIdpModel was null or undefined when calling updateOrganizationApplication.');
        }
        ...
        return this.httpClient.patch<ApplicationIdpModel>(`${this.configuration.basePath}/api/organization_applications/${encodeURIComponent(String(clientId))}`,
