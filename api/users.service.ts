...
// @ts-ignore
import { PatchUserIdpModel } from '../model/patchUser';
// @ts-ignore
...
export class UsersService {
     ...
     * @param userGuid Identifier for the user.
     * @param patchUserIdpModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateUser(userGuid: string, patchUserIdpModel: PatchUserIdpModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<UserIdpModel>;
    public updateUser(userGuid: string, patchUserIdpModel: PatchUserIdpModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<UserIdpModel>>;
    public updateUser(userGuid: string, patchUserIdpModel: PatchUserIdpModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<UserIdpModel>>;
    public updateUser(userGuid: string, patchUserIdpModel: PatchUserIdpModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (userGuid === null || userGuid === undefined) {
            throw new Error('Required parameter userGuid was null or undefined when calling updateUser.');
        }
        if (patchUserIdpModel === null || patchUserIdpModel === undefined) {
            throw new Error('Required parameter patchUserIdpModel was null or undefined when calling updateUser.');
        }
        ...
        return this.httpClient.patch<UserIdpModel>(`${this.configuration.basePath}/api/users/${encodeURIComponent(String(userGuid))}`,
            patchUserIdpModel,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
