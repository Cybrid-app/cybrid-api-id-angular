...
export namespace ApplicationIdpModel {
    export type ScopesEnum = 'organizations:read' | 'organizations:write' | 'banks:read' | 'banks:write' | 'banks:execute' | 'customers:read' | 'accounts:read' | 'quotes:read' | 'trades:read' | 'accounts:execute' | 'customers:write' | 'customers:execute' | 'prices:read' | 'quotes:execute' | 'trades:execute' | 'rewards:execute' | 'rewards:read';
    export const ScopesEnum = {
        ...
        Rewardsexecute: 'rewards:execute' as ScopesEnum,
