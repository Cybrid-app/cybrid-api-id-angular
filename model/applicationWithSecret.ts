...
export namespace ApplicationWithSecretIdpModel {
    export type ScopesEnum = 'organizations:read' | 'organizations:write' | 'banks:read' | 'banks:write' | 'banks:execute' | 'accounts:read' | 'accounts:execute' | 'customers:read' | 'customers:write' | 'customers:execute' | 'prices:read' | 'quotes:execute' | 'quotes:read' | 'trades:execute' | 'trades:read';
